...
#define InfoBasePtr 0x014516B0
#define MapIDOffset 0xFA4
#define CharXOffset 0xE70
 
#define StatsBasePtr 0x0144BC60
#define HPOffset 0x1EF4
#define MPOffset 0x1EF8
#define EXPOffset 0x1E20
 
#define MouseBasePtr 0x0144C180
#define MouseLocOffset 0x978
#define MouseXOffset 0x8C
#define MouseAniOffset 0x98
 
#define SettingsBasePtr 0x0144B994
#define HPAlertOffset 0x5C
#define MPAlertOffset 0x60
 
#define ServerBasePtr 0x01446FB0
#define TubiOffset 0x213C
#define WorldOffset 0x20C0
#define ChannelOffset 0x20C8

#define WallBasePtr 0x0144B8AC

#define MobBasePtr 0x0144B99C
#define MobCountOffset 0x10
 
#define PeopleBasePtr 0x0144B998
#define PeopleCountOffset 0x18
 
#define ItemBasePtr 0x01450DDC
#define ItemCountOffset 0x14
 
#define PortalBasePtr 0x0145169C
#define PortalCountOffset 0xC
 
#define SendAddy 0x004D70E0
#define SendClassAddy 0x0049AFD7
#define ClientSocketAddy 0x01447390

//Outdated start
#define pIDOffset 0x3108
